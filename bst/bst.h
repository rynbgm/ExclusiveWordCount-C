...
//  bst_search : renvoie NULL si ref vaut NULL. Recherche sinon dans l'arbre
//    binaire de recherche associé à t la référence d'un objet égal à celui de
//    référence ref au sens de la fonction de comparaison. Renvoie NULL si la
//    recherche est négative, la référence trouvée sinon.
...
//  bst_number, bst_rank : renvoie (size_t) (-1) si ref vaut NULL. Calcule sinon
//    le numéro, le rang du nœud de l'arbre binaire de recherche associé à t
//    dont la valeur est égale à celle de l'objet pointé par ref au sens de la
//    fonction de comparaison. Renvoie ce numéro, ce rang si une telle valeur
//    existe. Renvoie sinon le numéro, le rang qu'aurait le nœud si la référence
